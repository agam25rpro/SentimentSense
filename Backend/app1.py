...
nltk.download('wordnet', download_dir=str(NLTK_DATA))
...
# Keep your existing model architecture classes (MultiHeadAttention, PositionalEncoding, 
# TransformerBlock, TwitterSentimentTransformer) exactly as they are
# [Previous model classes remain unchanged]
...
def load_model_and_vocab():
    ...
    try:
        ...
        raise RuntimeError(f"Failed to load model or vocabulary: {str(e)}")
